...
if __name__ == "__main__":
    desc = Descifrar.Descifrar(
        "HZAHEOMICEVMEWFBTVKGWKAMLSTVUXEMZNPEZKLMYVMMDUEVXQFMZMZLCICESTHYCARVLEGVMMBUGEIPWJQLTAPVMFSZMFWIUZHYMKTUOINRWUGVMJLRGTYEMXDIAIQMCEABMHEEC",
        ["PERSONAS",
         "SOLARIS", "ESTAR"])
