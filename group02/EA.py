...
class EA(object):
    ...
    def __init__(self, function, mybounds, number, args):
        ...
        for i in range(number):
            ...
            genoma = Genome(vector, self.function, self.args)
    ...
    def run(self, iteraciones):
        ...
        while i < iteraciones and self.best.fitness != 0:
            ...
            for j in range(len(self.generation[i].lista)):
                ...
                mutationVector = myMutOp.apply(selection.lista, self.F)
                g_mutation = Genome(mutationVector, self.function,self.args)
                ...
                g_crossover = Genome(crossoverVector, self.function,self.args)
